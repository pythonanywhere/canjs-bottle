    ...
    <script id="app" type="text/stache">
      <div class="grid">
        ...
        <div class="grid__col grid__col--1-of-3 grid__col--centered margin-top-8px">
          Run this shit<button-details lookfor="runthisshit"></button-details><a href="#" class="button">Done</a>
        </div>
        <div class="grid__col grid__col--1-of-3 grid__col--centered margin-top-8px">
          Get out<button-details lookfor="getout"></button-details><a href="#" class="button">Done</a>
        </div>
        <div class="grid__col grid__col--1-of-3 grid__col--centered margin-top-8px">
          Eat<button-details lookfor="eat"></button-details><a href="#" class="button">Done</a>
        </div>
      </div>
    </script>
